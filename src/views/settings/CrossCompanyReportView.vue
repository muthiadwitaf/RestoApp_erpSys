  ...
  <div class="platform-page">
    <nav class="platform-navbar">
      ...
      <div class="platform-nav-links">
        ...
        <a class="platform-nav-link" href="#" @click.prevent="navigateTo('/platform/companies?sa=1')"><i class="bi bi-shield-lock me-1"></i>Super Admins</a>
      </div>
...
async function loadStats() {
  loading.value = true
  try { const { data } = await settingsApi.getCompanyStats(period.value); stats.value = data }
